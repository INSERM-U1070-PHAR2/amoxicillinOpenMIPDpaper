...
The folder /Sensitivity_analysis contains the codes which are necessary to execute a sensitivity analysis combined with the other codes found in this repository (for example, the functions for the different MIPD methods).
