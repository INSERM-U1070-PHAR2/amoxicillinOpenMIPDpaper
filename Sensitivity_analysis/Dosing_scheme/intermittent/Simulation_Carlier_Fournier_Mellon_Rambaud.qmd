...
here::i_am("Sensitivity_analysis/Dosing_scheme/intermittant/Simulation_Carlier_Fournier_Mellon_Rambaud.qmd")
...
regimens <- list(
  ...
  list(model_cohort = "CARLIER", ir_group = 1, dose = 1000, interval = 6, duration = 0.5),
  list(model_cohort = "FOURNIER", ir_group = 0, dose = 1000, interval = 6, duration = 0.5),
  list(model_cohort = "FOURNIER", ir_group = 1,dose = 1000, interval = 6, duration = 0.5),
  list(model_cohort = "MELLON", ir_group = 0, dose = 1000, interval = 6, duration = 0.5),
  list(model_cohort = "RAMBAUD", ir_group = 0, dose = 1000, interval = 6, duration = 0.5)
)
